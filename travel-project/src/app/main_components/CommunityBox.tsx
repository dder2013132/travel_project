export default function CommunityBox() {
  return (
    <div className="flex flex-col w-1/2 h-1/2 rounded-lg p-4 px-12 gap-8 bg-gray-100 items-start sm:items-start mb-8">
      ...
      <div className="w-full h-full p-4 bg-white rounded-lg shadow-md">
        <h1 className="text-xl font-bold border-b border-gray-400 italic mb-2">게시글 제목 1</h1>
        <span className="text-sm text-gray-500">작성자: 사용자 이름</span>
        <span className="text-sm text-gray-500">작성일: 2023-10-01</span>
      </div>
      <div className="w-full h-full p-4 bg-white rounded-lg shadow-md">
        <h1 className="text-xl font-bold border-b border-gray-400 italic mb-2">게시글 제목 2</h1>
        <span className="text-sm text-gray-500">작성자: 사용자 이름</span>
        <span className="text-sm text-gray-500">작성일: 2023-10-02</span>
      </div>
      <div className="w-full h-full p-4 bg-white rounded-lg shadow-md">
        <h1 className="text-xl font-bold border-b border-gray-400 italic mb-2">게시글 제목 3</h1>
        <span className="text-sm text-gray-500">작성자: 사용자 이름</span>
